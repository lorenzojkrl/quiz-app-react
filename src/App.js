...
const randomAnswer = (questionNumber, questionsJSON) => {
  console.log(`In randomAnswer - Correct answer: ${questionsJSON[questionNumber].correct_answer}`);
  let answersArray = [
    questionsJSON[questionNumber].correct_answer,
    questionsJSON[questionNumber].incorrect_answers[0],
    questionsJSON[questionNumber].incorrect_answers[1],
    questionsJSON[questionNumber].incorrect_answers[2]
  ];

  let randomizedAnswers = shuffle(answersArray);
  console.log('In randomAnswer - array Random answers: ', randomizedAnswers);
...
const App = () => {
  ...
  const [randomized, setRandomAnswers] = useState([])
  ...
  const Button = ({ text }) => {
    ...
    const handleMe = () => {
      console.log("In Button - handleMe clicked on: ", text)
      setQuestionsLeft(questionsLeft + 1)

      if (text === questionsJSON[questionNumber].correct_answer) {
        console.log("Correct answer");
        setScore(score + 1)
        setQuestionNumber(Math.floor(Math.random() * 50))
        console.log("questionNumber: ", questionNumber);
        let randomized = randomAnswer(questionNumber, questionsJSON)
        setRandomAnswers(randomized)
  ...
  const ButtonStart = ({ text }) => {
    const startQuiz = () => {
      setRandomAnswers(randomAnswer(questionNumber, questionsJSON))
      setPlay(1)
      console.log("In ButtonStart - startQuiz concluded");
    }
  ...
  return (
    <div className="App">
      ...
      {play === 0
        ? <ButtonStart text="Start Quiz!"></ButtonStart>
